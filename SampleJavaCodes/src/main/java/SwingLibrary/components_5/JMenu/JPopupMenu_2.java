 ...
 * release.
 * 
 * So, note that the MuneItems accept their own event listeneres (for when we
 * click on them). However, to show the actual pop-up, a mouse event has to be
 * registered with the frame, or the component in which we want to show the
 * pop-up (obviosuly of course).
 */
...
class JMenuFrame extends JFrame {
    private static final long serialVersionUID = 1231932204237005910L;
    ...
    private JMenu getHelpMenu() {
        ...
        indexMenuItem.addActionListener(e -> msgText.append("You have selected Help >>Index menu item.\n"));
        return helpMenu;
    }
